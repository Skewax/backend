...
func (m *LoginResponse) validateUser(formats strfmt.Registry) error {
...
func (m *LoginResponse) contextValidateUser(ctx context.Context, formats strfmt.Registry) error {
